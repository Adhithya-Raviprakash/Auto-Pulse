...
This project implements a complete **predictive maintenance pipeline** using the [NASA CMAPSS](https://data.nasa.gov/dataset/cmapss-jet-engine-simulated-data) turbofan engine degradation dataset.
